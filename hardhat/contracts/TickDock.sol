...
contract GDvent is ERC721URIStorage {
    constructor() ERC721("GDvent", "GDVT") {}
    ...
    function addEvent(
        ...
        Event memory eve = Event({
            ...
            ticketSold: 0,
            usersBought: new address[](_totalTickets),
            active: true,
            balances: 0
        });
        events.push(eve);
    ...
    function buyTicket(
        ...
        require(
            eventMapping[eventId].totalTickets >
    ...
    function withdraw(uint256 eventId) public {
        require(
            eventMapping[eventId].eventOwner == msg.sender,
            "not the owner"
        );
        (bool success, ) = (msg.sender).call{
            value: eventMapping[eventId].balances
        }("");
